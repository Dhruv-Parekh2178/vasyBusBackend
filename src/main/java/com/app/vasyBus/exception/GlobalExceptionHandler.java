...
import com.app.vasyBus.dtos.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleValidationErrors(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ApiResponse<>(false, "fail", error));
    }
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleInvalidCredentials(
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new ApiResponse<>(false , "fail" , error));
    }
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleResourceNotFound(
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ApiResponse<>(false , "fail" , error));
    }
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleGenericException(
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new ApiResponse<>(false , "fail" , error));
    }
}